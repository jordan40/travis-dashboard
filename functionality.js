...
for (var bucketName in buckets) {
	...
	buckets[bucketName].forEach (function (repo) {
		buffered_out += "<tr><th><a href='https://" + githubHost + "/"+ repo.owner + "/" + repo.name + "'>" + repo.name + "</a></th><td><a href='https://" + travisHost + "/"+ repo.owner + "/" + repo.name + "'>" + repo.badgeSVG + "</a></td><td><a href='https://" + githubHost + "/"+ repo.owner + "/" + repo.name + "/issues'>" + repo.issuesCount + "</a></td><td><a href='https://" + githubHost + "/"+ repo.owner + "/" + repo.name + "/pulls'>" + repo.pullRequestCount + "</a></td><td><a href='https://codeclimate.com/github/"+ repo.owner + "/" + repo.name + "'><img src='https://codeclimate.com/github/"+ repo.owner + "/" + repo.name + "/badges/gpa.svg' /></a></td></tr>";
	});
